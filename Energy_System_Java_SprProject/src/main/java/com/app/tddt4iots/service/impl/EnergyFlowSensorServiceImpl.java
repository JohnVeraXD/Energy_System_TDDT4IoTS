...
@Service
public class EnergyFlowSensorServiceImpl implements EnergyFlowSensorService {     
    @Autowired
    EnergyFlowSensorRepository energyFlowSensorRepository;
    
	@Override 
	public void retrieveConsumptionData() { 
